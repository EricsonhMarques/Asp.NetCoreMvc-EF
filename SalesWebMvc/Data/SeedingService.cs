...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", new DateTime(1998, 4, 21), "bob@gmail.com", 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", new DateTime(1979, 12, 31), "maria@gmail.com", 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", new DateTime(1988, 1, 15), "alex@gmail.com", 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red",  new DateTime(1993, 11, 30), "martha@gmail.com", 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue",  new DateTime(2000, 1, 9), "donald@gmail.com", 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink",  new DateTime(1997, 3, 4), "bob@gmail.com", 3000.0, d2);
